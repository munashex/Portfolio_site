    ...
    <div className="mt-11 lg:mt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="bg-[#EDEDED] p-4 space-y-3 rounded-xl lg:rounded-3xl">
            <h1 className="text-2xl font-bold md:text-3xl lg:text-4xl font-shantell">Munashe Mugonda</h1>
        ...
        <div className="bg-[#EDEDED] p-4 lg md:row-span-3 rounded-xl space-y-9 lg:rounded-3xl">
          <h1 className="text-2xl font-shantell font-bold md:text-3xl lg:text-4xl text-center">My Stack</h1>
          <DualSlider />
        </div>
        ...
        <div className="md:row-span-2">
         <div className="grid grid-cols-2 gap-x-2 justify-items-stretch">
           <div className="bg-[#EDEDED] p-4 rounded-xl lg:rounded-3xl py-9 space-y-1">
             ...
             <h1 className="font-bold text-2xl   text-center font-shantell">4 Years</h1>
           </div> 
           <div className="bg-[#EDEDED] p-4 rounded-xl lg:rounded-3xl py-9 space-y-1">
           <h1 className="text-[#8C8C8C] text-lg text-center">Freelance</h1>
           <h1 className="font-bold text-2xl  text-center font-shantell">30+ Projects</h1>
           </div>
         </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-x-2 justify-items-stretch">
           ...
           <a href="https://linkedin.com/in/munashe-madhuna-99676a210" className="bg-[#EDEDED] rounded-xl lg:rounded-3xl py-9 lg:py-14 flex justify-center items-center">
