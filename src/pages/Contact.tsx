...
const Contact = () => {
  const socialLinks = [
    ...
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/munashe-madhuna-99676a210/', icon: FaLinkedin },
  ];
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-4xl w-full px-4 py-8 space-y-8">
        <h1 className="text-5xl font-bold font-shantell md:text-7xl lg:text-9xl text-gray-800 animate-fade-in-down">
          Hello.
        </h1>
        <p className="text-lg lg:text-xl text-gray-600 max-w-2xl animate-fade-in-up">
